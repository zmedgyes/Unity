...
public class ListAStarPathfinding : MonoBehaviour
{


    ListPathRequestManager requestManager;
    Grid grid;
    ...
    public void StartFindPath(Vector3 startPos, Vector3 targetPos, List<Node> unwalkableNodes, List<Node> dynamicExceptions)
    {
        StartCoroutine(FindPath(startPos, targetPos,unwalkableNodes,dynamicExceptions));
    }
